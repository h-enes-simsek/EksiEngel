...
from .views import CollectActionDataView,EksiSozlukUserStatView, MostBannedUsersView, MostBannedUsersUniqueView, FailedActionsView, TotalActionView, TotalActionHTMLView
